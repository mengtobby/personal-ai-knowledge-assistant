/**
 * Liquid metal shader pair, vendored from collidingScopes/liquid-logo
 * (https://github.com/collidingScopes/liquid-logo), MIT License, Copyright (c) 2025 Alan Ang.
 * Ported as-is from fragment-shader.glsl / vertex-shader.glsl; only the uniform
 * defaults used to drive it (see LiquidLogo.tsx) are ours.
 */
